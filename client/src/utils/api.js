...
// Players
export const createPlayersApi = (formData) => api.post(`/players/create`,formData);
export const getAllPlayersApi = (auctionId) => api.get(`/players/all-players/${auctionId}`);
export const getPlayerByIdApi = (auctionId, playerId) => api.get(`/players/get-one/${auctionId}/${playerId}`);
export const updatePlayerApi = (formData) => api.put(`/players/update`,formData);
export const deletePlayer = (auctionId,playerId) => api.delete(`/players/delete/${auctionId}/${playerId}`);
